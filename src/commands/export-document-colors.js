...
export default function exportFromArtboard(context) {
  ...
  var text = uiSelect.objectValueOfSelectedItem();
  var exportName = uiSelect.stringValue();

  if(!exportName || exportName == '') {
    value = uiSelect.objectValueOfSelectedItem();
  }
  ...
  var colors = context.document.documentData().assets().primitiveColors().array();
  var usedNames = {};
